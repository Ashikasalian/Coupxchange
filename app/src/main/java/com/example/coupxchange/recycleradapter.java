...
public class recycleradapter extends FirebaseRecyclerAdapter<Free,recycleradapter.myviewholder> {

    public String coups;
    public recycleradapter(@NonNull FirebaseRecyclerOptions<Free> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull Free model) {
        holder.webname.setText(model.getStore());
        holder.wcoupon.setText(model.getCode());
